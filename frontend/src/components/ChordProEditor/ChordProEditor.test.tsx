...
describe('ChordProEditor', () => {
  ...
  describe('User Interactions', () => {
    ...
    it('handles backspace and deletion', async () => {
      ...
      const onChange = vi.fn();
      render(
        <ChordProEditor {...defaultProps} value="Hello" onChange={onChange} />
      );
...
{end_of_chorus}`;
  ...
  describe('Edge Cases', () => {
    ...
    it('handles special characters', () => {
      const specialValue =
        'Émile sings café songs with 中文 characters and emoji 🎵';
