...
// Mock the components
vi.mock('../../components', () => ({
  ChordProEditor: ({ value, onChange }: any) => (
    <textarea
...
describe('Home Component', () => {
  ...
  describe('Create Song Functionality', () => {
    ...
    it('creates a new song successfully', async () => {
      ...
      mockApiService.createSong.mockResolvedValue({
        status: 'success',
        data: { song: { id: '3', ...newSong, created_at: '2023-01-03T00:00:00Z', updated_at: '2023-01-03T00:00:00Z' } },
      });
  ...
  describe('Song Actions', () => {
    ...
    it('handles download error', async () => {
      ...
      mockApiService.downloadSong.mockRejectedValue(new Error('Download failed'));
  ...
  describe('File Upload', () => {
    ...
    it('handles file upload', async () => {
      const user = userEvent.setup();
      const file = new File(['[C]File content'], 'test.cho', { type: 'text/plain' });
      ...
      mockApiService.createSong.mockResolvedValue({
        status: 'success',
        data: { song: { id: '1', title: 'test', content: '[C]File content', created_at: '2023-01-01T00:00:00Z', updated_at: '2023-01-01T00:00:00Z' } },
      });
      ...
      mockFileReader.onload?.({ target: { result: '[C]File content' } } as any);
  ...
  describe('UI State Management', () => {
    ...
    it('shows empty state when no songs', () => {
      expect(screen.getByText('No songs found. Create your first song!')).toBeInTheDocument();
    });
    ...
    it('hides create form when edit form is opened', async () => {
      ...
      mockApiService.getSongs.mockResolvedValue({
        status: 'success',
        data: { songs: [{ id: '1', title: 'Test', content: '[C]Test', created_at: '2023-01-01T00:00:00Z', updated_at: '2023-01-01T00:00:00Z' }] },
      });
