...
describe('Register Component', () => {
  ...
  describe('Form Rendering', () => {
    it('renders registration form', () => {
      ...
      expect(screen.getByRole('heading', { name: 'Join ChordMe' })).toBeInTheDocument();
    ...
    it('has proper form structure', () => {
      ...
      const form = screen.getByRole('form') || screen.getByTestId('register-form') || document.querySelector('form');
