...
describe('Firestore CRUD Operations - Integration Tests', () => {
  ...
  beforeAll(async () => {
    try {
      ...
      console.warn(
        'Firebase emulator not available. Integration tests will be skipped.'
      );
  ...
  describe('Song CRUD Operations', () => {
    ...
    describe('Create Operations', () => {
      ...
      it('should handle creation with missing fields', async () => {
        ...
        const docRef = await assertSucceeds(
          addDoc(songsRef, incompleteSongData)
        );
        expect(docRef.id).toBeDefined();
      });
    });
    ...
    describe('Update Operations', () => {
      ...
      it('should handle updating metadata fields', async () => {
        ...
        expect(data?.created_at.toMillis()).toBe(
          songData.created_at.toMillis()
        ); // Unchanged
      });
