...
describe('Firestore Security Rules', () => {
  ...
  beforeAll(async () => {
    try {
      ...
      console.warn(
        'Firebase emulator not available. Security rules tests will be skipped.'
      );
  ...
  describe('Authentication Requirements', () => {
    it('should deny all access to unauthenticated users', async () => {
      ...
      await assertFails(
        getDoc(doc(unauthedContext.firestore(), 'users', USER_1_ID))
      );
      await assertFails(
        setDoc(
          doc(unauthedContext.firestore(), 'users', USER_1_ID),
          validUserData
        )
      );
      ...
      await assertFails(
        getDoc(doc(unauthedContext.firestore(), 'songs', SONG_1_ID))
      );
      await assertFails(
        setDoc(
          doc(unauthedContext.firestore(), 'songs', SONG_1_ID),
          validSongData
        )
      );
      ...
      await assertFails(
        getDoc(doc(unauthedContext.firestore(), 'chords', CHORD_1_ID))
      );
      await assertFails(
        setDoc(
          doc(unauthedContext.firestore(), 'chords', CHORD_1_ID),
          validChordData
        )
      );
    });
  ...
  describe('Users Collection Security', () => {
    it('should allow users to read their own user document', async () => {
      ...
      await assertSucceeds(
        setDoc(doc(user1Context.firestore(), 'users', USER_1_ID), validUserData)
      );

      // Then read it
      await assertSucceeds(
        getDoc(doc(user1Context.firestore(), 'users', USER_1_ID))
      );
    });
    ...
    it('should deny users from reading other users documents', async () => {
      ...
      await assertFails(
        getDoc(doc(user2Context.firestore(), 'users', USER_1_ID))
      );
    });
    ...
    it('should deny users from creating other users documents', async () => {
      ...
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'users', USER_2_ID), validUserData)
      );
    });
    ...
    it('should validate user data structure', async () => {
      ...
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'users', USER_1_ID), {
          email: 'test@example.com',
        })
      );
    ...
    it('should allow updating user data but preserve creation time', async () => {
      ...
      await assertSucceeds(
        updateDoc(doc(user1Context.firestore(), 'users', USER_1_ID), {
  ...
  describe('Songs Collection Security', () => {
    it('should allow users to create songs they own', async () => {
      ...
      await assertSucceeds(
        setDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID), validSongData)
      );
    });
    ...
    it('should deny users from creating songs for other users', async () => {
      ...
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID), songForUser2)
      );
    });
    ...
    it('should allow users to read their own songs', async () => {
      ...
      // Read song
      await assertSucceeds(
        getDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID))
      );
    });
    ...
    it('should deny users from reading other users songs', async () => {
      ...
      await assertFails(
        getDoc(doc(user2Context.firestore(), 'songs', SONG_1_ID))
      );
    });
    ...
    it('should allow users to update their own songs', async () => {
      ...
      // Update song
      await assertSucceeds(
        updateDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID), {
    ...
    it('should deny users from updating other users songs', async () => {
      ...
      await assertFails(
        updateDoc(doc(user2Context.firestore(), 'songs', SONG_1_ID), {
          title: 'Hacked Title',
        })
      );
    });
    ...
    it('should allow users to delete their own songs', async () => {
      ...
      // Delete song
      await assertSucceeds(
        deleteDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID))
      );
    });
    ...
    it('should deny users from deleting other users songs', async () => {
      ...
      await assertFails(
        deleteDoc(doc(user2Context.firestore(), 'songs', SONG_1_ID))
      );
    });
    ...
    it('should validate song data structure', async () => {
      ...
      // Missing required fields
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'songs', SONG_1_ID), {
          title: 'Test Song',
          author_id: USER_1_ID,
        })
      );
    ...
    it("should allow querying user's own songs", async () => {
      ...
      await assertSucceeds(
        setDoc(doc(user1Context.firestore(), 'songs', SONG_2_ID), {
          ...validSongData,
          title: 'Second Song',
        })
      );
  ...
  describe('Chords Collection Security', () => {
    it('should allow users to create chords they own', async () => {
      ...
      await assertSucceeds(
        setDoc(
          doc(user1Context.firestore(), 'chords', CHORD_1_ID),
          validChordData
        )
      );
    });
    ...
    it('should allow users to read their own chords', async () => {
      ...
      // Read chord
      await assertSucceeds(
        getDoc(doc(user1Context.firestore(), 'chords', CHORD_1_ID))
      );
    });
    ...
    it('should deny users from reading other users chords', async () => {
      ...
      await assertFails(
        getDoc(doc(user2Context.firestore(), 'chords', CHORD_1_ID))
      );
    });
    ...
    it('should validate chord data structure', async () => {
      ...
      // Missing required fields
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'chords', CHORD_1_ID), {
          name: 'C',
          owner_id: USER_1_ID,
        })
      );
  ...
  describe('Security Boundary Tests', () => {
    it('should deny access to undefined collections', async () => {
      ...
      await assertFails(
        getDoc(doc(user1Context.firestore(), 'undefined-collection', 'doc1'))
      );
      await assertFails(
        setDoc(doc(user1Context.firestore(), 'undefined-collection', 'doc1'), {
          data: 'test',
        })
      );
    });
