...
const COMMON_CHORDS = [
  ...
  // Common slash chords
  'C/E', 'D/F#', 'F/C', 'G/B', 'Am/C',
  
  // Diminished and augmented
  'Cdim', 'Ddim', 'Fdim', 'Gdim', 'Caug', 'Faug',
];
 ...
 */
export function getChordSuggestions(input: string, maxSuggestions: number = 10): ChordSuggestion[] {
 ...
 */
export function detectChordInput(text: string, cursorPosition: number): {
  isInChord: boolean;
  chordStart?: number;
  chordEnd?: number;
  chordText?: string;
